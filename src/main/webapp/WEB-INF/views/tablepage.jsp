<div style="margin-top: 5%" ng-controller="TableCtrl as table">
    <div class="panel">
        <div class="input-daterange">
            ...
            <input type="text" id="startDateId" class="date-range-filter" data-date-format="mm/dd/yyyy" placeholder="Start Date...">
            <input type="text" id="endDateId" class="date-range-filter" data-date-format="mm/dd/yyyy" placeholder="End Date...">
